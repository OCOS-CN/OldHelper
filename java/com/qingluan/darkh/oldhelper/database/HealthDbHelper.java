...
public class HealthDbHelper extends SQLiteOpenHelper {
    ...
    private static String DatabaseName = "health.db";
    private  String ARG_ID ="id";
    private static String TableName = "Health";
    ...
    public HealthDbHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public Boolean update(String name_id  ,ContentValues updateValue){
        ...
        return this.localdb.update(HealthDbHelper.TableName,updateValue,NAME_ID + "=" +name_id,null) >0;
    }
